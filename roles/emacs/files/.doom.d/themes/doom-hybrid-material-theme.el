...
;;
(defgroup doom-hybrid-material-theme nil
...
Can be an integer to determine the exact padding."
  :group 'doom-hybrid-material-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-hybrid-material
  ...
  ((bg         '("#263238" nil       nil))
   ...
   (red         '("#cc6666" "#ff0000" "red"))
   ;; (red         '("#ff5370" "#ff0000" "red"))
   (orange      '("#de935f" "#ff5f00" "brightred"))
   ;; (orange      '("#f78c6c" "#ff5f00" "brightred"))
   (green       '("#b5bd68" "#afff00" "green"))
   ;; (green       '("#c3e88d" "#afff00" "green"))
   (teal        '("#8abeb7" "#00d7af" "brightgreen"))
   ;; (teal        '("#44b9b1" "#00d7af" "brightgreen"))
   (yellow      '("#f0c674" "#ffd700" "brightyellow"))
   ;; (yellow      '("#ffcb6b" "#ffd700" "brightyellow"))
   (blue        '("#81a2be" "#5fafff" "brightblue"))
   ;; (blue        '("#82aaff" "#5fafff" "brightblue"))
   (dark-blue   '("#7986E7" "#d7ffff" "blue"))
   ;; (dark-blue   '("#7986E7" "#d7ffff" "blue"))
   (magenta     '("#b294bb" "#d787d7" "brightmagenta"))
...
(provide 'doom-hybrid-material-theme)
